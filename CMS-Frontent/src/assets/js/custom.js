...
$(document).ready(function () {
  $(document).mousemove(function (e) {
    ...
    var y = e.clientY;
    var imgx1 = $(
      ".product-d-main-slider div.slick-active .slideshow-items"
    ).offset()?.left;
    var imgx2 =
      $(
        ".product-d-main-slider div.slick-active .slideshow-items"
  ...
  const mouseTarget = document.querySelector("#main-p-slider");

  mouseTarget.addEventListener("mouseenter", (e) => {
    debugger;
    $("#main-p-slider").addClass("active-lense");
    mouseTarget.style.color = "green";
  });

  mouseTarget.addEventListener("mouseleave", (e) => {
    debugger;
    $("#main-p-slider").removeClass("active-lense");
