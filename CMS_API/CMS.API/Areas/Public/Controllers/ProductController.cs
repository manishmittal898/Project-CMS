...
namespace CMS.API.Areas.Public.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public object Get(string id, bool isThumbnail = false)
        {
            return _productmstr.GetById(id, isThumbnail);
        }


        // GET api/<ProductMasterController>/5
        [HttpGet("{id}/{sizeId}")]
        public object GetStockDetail(string id, string sizeId)
        {
            return _productmstr.GetStockDetail(id, sizeId);
        }
    }
}
