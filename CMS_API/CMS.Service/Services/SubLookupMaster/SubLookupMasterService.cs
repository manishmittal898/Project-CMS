    ...
    public class SubLookupMasterService : BaseService, ISubLookupMasterService
    {
        ...
        public ServiceResponse<TblSubLookupMaster> GetById(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                ObjResponse = CreateResponse<TblSubLookupMaster>(null, "Fail", false, (int)ApiStatusCode.InternalServerError, ex.Message.ToString());
        ...
        public async Task<ServiceResponse<TblSubLookupMaster>> Save(SubLookupMasterViewModel model)
        {
            ...
            catch (Exception ex)
            {
                ...
                return CreateResponse<TblSubLookupMaster>(null, "Fail", false, (int)ApiStatusCode.InternalServerError , ex.Message.ToString());
