...
namespace CMS.Service.Services.SubLookupMaster
{
    public class SubLookupMasterService : BaseService, ISubLookupMasterService
    {
        ...
        public SubLookupMasterService(DB_CMSContext db, IHostingEnvironment environment)
        {
            _db = db;
        ...
        public async Task<ServiceResponse<IEnumerable<SubLookupMasterViewModel>>> GetList(IndexModel model)
        {
            ...
            try
            {
                ...
                if (result != null)
                {
                    ...
                    return CreateResponse(objResult.Data as IEnumerable<SubLookupMasterViewModel>, ResponseMessage.Success, true, ((int)ApiStatusCode.Ok), TotalRecord: result.Count());
                }
                else
                {
